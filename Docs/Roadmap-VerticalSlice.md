...
- No incluido en este vertical slice (fuera de alcance salvo que se decida sumarlo después): múltiples facciones/jugadores, mejoras/tecnología, más de un tipo de unidad melee/ranged, guardado de partida, generación procedural del mapa/camino y las herramientas de editor que esa generación necesita diseñar primero (diseño de ambas en [Design-MapEditorAndProceduralGeneration.md](Design-MapEditorAndProceduralGeneration.md)).
